...
class TSMgr:
    def __init__(self):
        self.pro = ts.pro_api('854634d420c0b6aea2907030279da881519909692cf56e6f35c4718c')
    ...
    def get_global_index_quotes(self, code):
        ...
        df = self.pro.index_global(**{
            ...
            "limit": "",
            "offset": ""
        }, fields=["ts_code", "trade_date", "open", "close", "high", "low", "pre_close", "change", "pct_chg", "swing",
                   "vol"])
        return df
    ...
    def get_etf_quotes(self, code):
        df = self.pro.fund_daily(**{
            ...
            "limit": "",
            "offset": ""
        }, fields=["ts_code", "trade_date", "pre_close", "open", "high", "low", "close", "change", "pct_chg", "vol",
                   "amount"])
        return df
